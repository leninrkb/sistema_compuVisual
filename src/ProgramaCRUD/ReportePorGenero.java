 ...
 * @author lenin
 */
public class ReportePorGenero extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReportePorCurso
     */
    public ReportePorGenero() {
        initComponents();
        cargarGeneros();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportePorGenero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportePorGenero().setVisible(true);
            }
        });
    }
